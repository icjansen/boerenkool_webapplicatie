...
?>
    <div class="container-fluid page_container">
        <div class="container col-sm-3 desktop_version">
            <a data-toggle="tab" href="#home"><img src="images/logoaventus.png" alt="logo"></a>
        ...
        <div class="col-sm-9 content_container">
            <div class="tab-content">
                <div id="home" class="tab-pane fade in active">
                    <h1>Kies in de navigatiebalk aan de linkerkant een type applicatie om te sorteren.</h1>
                    <?php
                    $all_projects=new Project();
                    $result=$all_projects->getAllProjects();
