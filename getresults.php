...
while($row=mysqli_fetch_array($result)) {
    ...
    <div class="custom_card col-xs-12 col-sm-6">
        ...
        <button type="button" class="btn btn-info btn-lg card_btn btn btn-primary" data-toggle="modal" data-target="#myModal<?php echo $row['project_id'] . "-" . $row['project_id'] ?>">Ga naar project</button>
    </div>

    <div class="modal fade" id="myModal<?php echo $row['project_id'] . "-" . $row['project_id'] ?>" role="dialog">
                ...
                <div class="modal-body project_details">
                    <div class="row">
                        <div class="img_container col-xs-12 col-sm-6">
                            <div id="myCarousel<?php echo $row['project_id'] . "-" . $row['project_id'] ?>" class="carousel slide" data-ride="carousel">
                                ...
                                <div class="carousel-inner">
                                    ...
                                    <a class="right carousel-control" href="#myCarousel<?php echo $row['project_id'] . "-" . $row['project_id'] ?>" data-slide="next">
